...
impl Extension {
    ...
    pub fn size(&self) -> usize {
        2 + match self {
            ...
            Self::ServerName(e) => todo!(),
            Self::StatusRequest(e) => todo!(),
            Self::SupportedGroups(e) => todo!(),
            Self::EcPointFormats() => todo!(),
            Self::SignatureAlgorithms(e) => todo!(),
            Self::ApplicationLayerProtocolNegotiation() => todo!(),
            Self::ExtendedMainSecret() => todo!(),
            Self::SessionTicket() => todo!(),
            Self::SupportedVersions(e) => todo!(),
